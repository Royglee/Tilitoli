...
/**A hálózaton elérhető játékokat tároló osztály.
...
public class GameList
{
	...
	/**Belenyomunk egy packet-et, és ha az megfelelő formátumú, felveszi a megfelelő játékot a listára.
	 * @param p
	...
	/**Megadja, hogy az elérhető játékmesterek között szerepel-e adott nevű.
	 * @param name
	 * Keresett játékosnév.
	 * @return
	 * true ha szerepel a név az elérhető játékosok között.
	 */
